...
class MeshtasticInterface:
    def __init__(self, config: ConfigManager, meshtastic_interface_instance: Union[SerialInterface, TCPInterface]) -> None:
        self.config: ConfigManager = config
        self.logger = log.logger
        self.interface: Union[SerialInterface, TCPInterface] = meshtastic_interface_instance
