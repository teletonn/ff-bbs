...
```sh
git clone https://github.com/YOUR_USERNAME/ff-bbs.git
cd ff-bbs
```
...
```
 The basic brodcast message can be setup in condig.ini. For advanced, See mesh_bot.py around the bottom of file, line 1491 to edit the schedule. See [schedule documentation](https://schedule.readthedocs.io/en/stable/) for more. Recomend to backup changes so they dont get lost.
